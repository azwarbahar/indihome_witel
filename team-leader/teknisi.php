                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <div class="sp-wrap">
                                                    <a href="../assets/images/teknisi/<?php echo $dta['foto_teknisi'] ?>"><img src="../assets/images/teknisi/<?php echo $dta['foto_teknisi'] ?>" alt=""  border=3 height=40 width=40></a>
                                                </div>
                                            </td>
                                            ...
                                            <div class="modal-dialog" style="width:40%;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body row" style="padding: 20px 50px 0 50px">
                                                        <div class="col-md-4">
                                                            <div class="sp-wrap">
                                                                <a href="../assets/images/teknisi/<?php echo $dta['foto_teknisi'] ?>"><img src="../assets/images/teknisi/<?php echo $dta['foto_teknisi'] ?>" alt="user-img" class="img-circle" style="border: 1px solid; height: 100px;"></a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <h4>Info Teknisi</h4>
